...
export const servicesData = [
    {
      title: "Bespoke Development",
      description: "Tailored Software Solutions",
      fullDescription: "We create precise, scalable software tailored to your needs, improving productivity and integrating smoothly into your business.",
      image: "/serviceimages/2.png",
      fullCover: true,
      path: "/bespoke"
    },
    {
      title: "Innovation Lab",
      description: "Transform Ideas to Software!",
      fullDescription: "We turn bold ideas into working software through rapid prototyping and collaboration, helping you launch faster.",
      image: "/serviceimages/1.png",
      fullCover: true,
      path: "/innovation"
    },
    {
      title: "User Experience",
      description: "Experience-Driven Design",
      fullDescription: "We design clean, intuitive interfaces that improve usability and keep users engaged across platforms.",
      image: "/serviceimages/3.png",
      fullCover: true,
      path: "/userexperience"
    },
    {
      title: "Digital Transformation",
      description: "Process Automation",
      fullDescription: "We automate workflows and integrate modern tech to cut costs, boost speed, and drive innovation.",
      image: "/serviceimages/4.jpg",
      fullCover: true,
      path: "/digital-transformation"
    },
    {
      title: "Cloud Solutions",
      description: "Scalable & Secure Cloud Services",
      fullDescription: "We offer secure, scalable cloud setups that improve performance and make infrastructure easier to manage.",
      image: "/serviceimages/5.jpg",
      fullCover: true,
      path: "/cloud"
    },
    {
      title: "Intelligent Systems",
      description: "AI-Powered Intelligence",
      fullDescription: "We use AI to automate tasks, predict outcomes, and help you make smarter business decisions.",
      image: "/serviceimages/6.jpg",
      fullCover: true,
      hasExpand: true,
      path: "/intelligent-systems"
    },
    {
      title: "No-Code & Low-Code Platforms",
      description: "Launch Websites & Apps Effortlessly",
      fullDescription: "We help you build apps and sites using platforms like Wix, Bubble, and Shopify—fast and code-free.",
      image: "/serviceimages/7.jpg",
      fullCover: true,
      path: "/nocode"
    },
    {
      title: "AI & ML-Driven Automation",
      description: "Smart Automation with AI & ML",
      fullDescription: "We develop AI tools like chatbots and models to automate tasks and personalize user experiences.",
      image: "/serviceimages/8.jpg",
      fullCover: true,
      path: "/ai-automation"
    }
